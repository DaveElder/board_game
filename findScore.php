...
$uid="root";
 ...
 $sql = "SELECT * FROM scoring WHERE gameID = '".$id."'";
...
if(mysqli_num_rows($result) > 0) {
	...
	while($row = mysqli_fetch_assoc($result)){
		echo "<form  method='post' action='changeDataScore.php'>";
	echo "<tr><td>";	
	echo "gameID: <input type='text' name='gameID' value='"   .$row["gameID"]. "'><br>";
	echo "<tr><td>";
	echo "Score: <input type='text' value='"	        	.$row["score"]. "'><br>";
